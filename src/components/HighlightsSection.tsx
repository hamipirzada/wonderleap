  ...
  const highlights = [
    {
      ...
      description: "Embark on epic Minecraft adventures in our career kingdoms.",
    ...
    },
    {
      ...
      description: "Discover noble professions explained for young minds.",
    ...
    },
    {
      ...
      description: "Built around future skills and career development.",
